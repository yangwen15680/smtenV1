...
#define kLabelFont [UIFont fontWithName:@"HelveticaNeue" size:49]
#define kColorFontNormal [UIColor whiteColor]
#define kColorFontHighlighted [UIColor blueColor]
...
- (void) setStyleType:(ACPButtonType)style {
    ...
    switch (style) {
            ...
            --------------------------------------------------------------------------*/
        case ACPButtonMain:
            _topColor = [UIColor colorWithRed:28/255.0 green:191/255.0 blue:215/255.0 alpha:1];
            _bottomColor= [UIColor colorWithRed:28/255.0 green:191/255.0 blue:215/255.0 alpha:1];
        ...
        case ACPButtonPurple:
            _topColor = [UIColor colorWithRed:205/255.0 green:39/255.0 blue:39/255.0 alpha:1];
            _bottomColor= [UIColor colorWithRed:194/255.0 green:40/255.0 blue:40/255.0 alpha:1];
            _borderColor = [UIColor colorWithRed:0.627451 green:0.627451 blue:0.627451 alpha:1] ;
            _inneColor = nil;
            break;
